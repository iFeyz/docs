...
Tous les appels passent par HTTPS sur la base `https://api.imoria.net/mcp`. Le protocole utilisé est JSON-RPC 2.0 over HTTP, avec support SSE pour les flux longs.
